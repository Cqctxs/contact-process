              ...
              <div className="bg-gray-900/80 p-5 md:p-6 rounded-xl border border-gray-700">
                ...
                <div className="bg-gray-800 p-4 rounded-lg border-l-2 border-indigo-500">
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    oxidation of sulfur dioxide (SO₂) to sulfur trioxide (SO₃)
                    using oxygen (O₂). The balanced chemical equation for this
                    equilibrium is:
                  </p>
                  ...
                  <p className="text-gray-300 leading-relaxed mt-2">
                    ...
                    production. The SO₃ is then absorbed in concentrated

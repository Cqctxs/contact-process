              ...
              <div className="bg-gray-900/80 p-5 md:p-6 rounded-xl border border-gray-700">
                ...
                <div className="bg-gray-800 p-4 rounded-lg border-l-2 border-indigo-500">
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    from a variet of other industrial processes as a waste
                    ...
                    reversible, so is easy for industrial chemists to control.
                    The balanced chemical equation for thisequilibrium is:
                  </p>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    multiple factors must be controled to maintain optimal
